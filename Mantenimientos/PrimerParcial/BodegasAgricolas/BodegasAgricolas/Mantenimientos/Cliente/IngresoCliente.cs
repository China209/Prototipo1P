    ...
    public partial class IngresoCliente : Form
    {
        ...
        private bool insertarCargos()
        {
            try
            {
                ...
                string cadena = "INSERT INTO cliente (nombre, apellido, nit, dpi, telefono, correo, direccion, estado) VALUES ('" + txtNombre.Text + "','" + txtApellido.Text + "','" + txtNIT.Text + "','" + txtDPI.Text + "','" + txtTelefono.Text + "','" + txtCorreo.Text + "','" + txtDireccion.Text + "', 1);";
        ...
        {
            AECliente actualizar = new AECliente();
            actualizar.Show();
            this.Hide();
        }
